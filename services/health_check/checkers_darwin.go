...
// getDiskUsage returns disk usage statistics for the given path (Darwin implementation)
func getDiskUsage(path string) (*DiskStats, error) {
	...
	// Use Darwin statfs syscall
	return getDiskUsageDarwin(path)
}

// getDiskUsageDarwin provides Darwin/macOS-specific disk usage using statfs syscall
func getDiskUsageDarwin(path string) (*DiskStats, error) {
