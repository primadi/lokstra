...
// Begin implements Tx.
func (p *pgxTxWrapper) Begin(ctx context.Context) (Tx, error) {
...
// Exec implements Tx.
func (p *pgxTxWrapper) Exec(ctx context.Context, query string, args ...any) (CommandResult, error) {
...
// Query implements Tx.
func (p *pgxTxWrapper) Query(ctx context.Context, query string, args ...any) (RowIterator, error) {
...
func (p *pgxTxWrapper) QueryRow(ctx context.Context, query string, args ...any) RowScanner {
...
func (p *pgxTxWrapper) SelectManyWithMapper(ctx context.Context, fnScan func(RowScanner) (any, error), query string, args ...any) (any, error) {
...
func (p *pgxTxWrapper) Transaction(ctx context.Context, fn func(tx DBConn) error) error {
