...
func TestServeMux_BasicRouting(t *testing.T) {
	engine := NewServeMux()
...
func TestServeMux_HeadAutoGeneration(t *testing.T) {
	engine := NewServeMux()
...
func TestServeMux_OptionsHandling(t *testing.T) {
	engine := NewServeMux()
	...
	// Should contain GET, HEAD (auto-generated), POST
	expectedMethods := []string{"GET", "HEAD", "POST"}
...
func TestServeMux_AnyMethod(t *testing.T) {
	engine := NewServeMux()
