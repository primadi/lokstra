...
1. `@RouterService` on `UserService` struct
...
- Line 8: `@RouterService` in RegisterMiddleware doc (TAB-indented)
...
```go
// @RouterService name="service-name"
