...
- `@EndpointService`, `@Inject`, and `@Route` annotations
...
├── application/
│   └── tenant_service.go      # @EndpointService + @Inject + @Route
├── config/
...
## 🧩 Annotations: `@EndpointService`, `@Inject`, `@Route`
...
- Parses `@EndpointService`, `@Inject`, and `@Route` annotations.
