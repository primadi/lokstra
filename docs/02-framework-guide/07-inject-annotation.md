...
The `@Inject` annotation marks struct fields for automatic dependency injection. It works with both `@Service` and `@Handler` annotations.
...
- [@Handler](05-router-service-annotation.md) - HTTP services
