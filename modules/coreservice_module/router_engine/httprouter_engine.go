...
func (h *HttpRouterEngine) ServeReverseProxy(prefix string, target string) {
	if h.sm == nil {
		...
		h.sm = smAny.(core_service.RouterEngine)
		h.hr.NotFound = h.sm
	}
...
var _ core_service.RouterEngine = (*HttpRouterEngine)(nil)
